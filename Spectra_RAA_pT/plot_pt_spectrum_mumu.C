...
void plot_spectrum_pt_0_20(){
  ...
  TH2F * h_dummy2=new TH2F("h_dummy2",";#it{p}_{T} (GeV/#it{c}); Model/Data",100,0,20,100,1e-2,5);
  ...
  legend->AddEntry( gr_PtSpecStat5020_00_20,"Data","P");
  legend->AddEntry(gr_PtSpecTM15020_00_20_model,"TAMU","f");
  legend->AddEntry(gr_PtSpecTM25020_00_20_model,"THU","f");
  legend->AddEntry(gr_PtSpecSHM5020_00_20_model,"SHM","f");
  legend->Draw();
...
void plot_spectrum_pt_20_40(){
  ...
  SetLegend(legend,42,0.06,0.0,0.0,0.0,0.0);
  legend->AddEntry( gr_PtSpecStat5020_20_40,"Data","P");
  legend->AddEntry(gr_PtSpecTM15020_20_40_model,"TAMU","f");
  legend->AddEntry(gr_PtSpecTM25020_20_40_model,"THU","f");  
  legend->AddEntry(gr_PtSpecSHM5020_20_40_model,"SHM","f");
  legend->Draw();
...
void plot_spectrum_pt_40_90(){
  ...
  TLegend *legend = new TLegend(0.2,0.17,0.5,0.45);
  SetLegend(legend,42,0.06,0.0,0.0,0.0,0.0);
  legend->AddEntry( gr_PtSpecStat5020_40_90,"Data","P");
  legend->AddEntry(gr_PtSpecTM15020_40_90_model,"TAMU","f");
  legend->AddEntry(gr_PtSpecTM25020_40_90_model,"THU","f");  
  legend->AddEntry(gr_PtSpecSHM5020_40_90_model,"SHM","f");
  legend->Draw();
