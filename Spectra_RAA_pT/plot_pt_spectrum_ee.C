...
void plot_pt_spectrum_ee()
{
  ...
  fileSHM_pt_spectrum_0_10 = "../models/SHMc/gPtSHMc_midy_0_10.txt";    
  ...
  fileSHM_pt_spectrum_30_50 = "../models/SHMc/gPtSHMc_midy_30_50.txt";    
...
void plot_spectrum_pt_0_10(){
  ...
  TGraph * gr_PtSpecSHM5020_00_10_model=   (TGraph *)GetPtSpecTM1_5020_model(16,fileSHM_pt_spectrum_0_10);
  ...
  TGraph * gr_ratio_PtSpecSHM_data=(TGraph *) GetRatioDataModel(gr_PtSpecStat5020_00_10,gr_PtSpecSyst5020_00_10,gr_PtSpecSHM5020_00_10_model);
  ...
  SetPad(pad1,0.02,0.,0.14,0.02);
  SetPad(pad2,0.,0.28,0.14,0.02);
  ...
  tex1.SetNDC();
  tex1.DrawLatex(0.40,0.88,"ALICE");
  tex1.SetTextSize(0.062);

  tex1.DrawLatex(0.40,0.8,"Pb#font[122]{-}Pb, 0#font[122]{-}10%, #sqrt{#it{s}_{NN}} = 5.02 TeV");
  tex1.DrawLatex(0.40,0.72,"Inclusive J/#psi, |#it{y}| < 0.9");
...
void plot_spectrum_pt_30_50(){
  ...
  TGraph * gr_PtSpecSHM5020_30_50_model=   (TGraph *)GetPtSpecTM1_5020_model(12,fileSHM_pt_spectrum_30_50);
  ...
  TGraph * gr_ratio_PtSpecSHM_data=(TGraph *) GetRatioDataModel(gr_PtSpecStat5020_30_50,gr_PtSpecSyst5020_30_50,gr_PtSpecSHM5020_30_50_model);
  ...
  gr_ratio_PtSpecSHM_data  ->SetFillColorAlpha(ci1,0.15);
  gr_ratio_PtSpecSHM_data ->SetLineColor(ci1);
  ...
  TH2F * h_dummy1=new TH2F("h_dummy1",";#it{p}_{T} (GeV/#it{c});1/#it{N}_{ev}d^{2}#it{N}/(d#it{y}d#it{p}_{T}) (GeV/#it{c})^{-1}",100,0,15,100,6e-7,3e-2);
  ...
  tex1.DrawLatex(0.40,0.8,"Pb#font[122]{-}Pb, 30#font[122]{-}50%, #sqrt{#it{s}_{NN}} = 5.02 TeV");
  tex1.DrawLatex(0.40,0.72,"Inclusive J/#psi, |#it{y}| < 0.9");
